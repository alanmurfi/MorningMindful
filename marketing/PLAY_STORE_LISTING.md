# Google Play Store Listing - Morning Mindful

## App Title (30 characters max)
```
Morning Mindful: Journal First
```

**Alternative titles:**
- `Morning Mindful - Block & Journal`
- `Morning Mindful: Screen Time`
...
## Screenshot Captions (for your 8 screenshots)

1. **"Journal First, Then Scroll"** - Show home screen with blocking active
2. **"Choose Your Blocked Apps"** - App selection screen
...
```
[0-3s] Phone alarm rings. Hand reaches for phone.

[3-8s] Opens Instagram... BLOCKED. Morning Mindful appears.
Text: "Not so fast..."
...
[20-25s] Show streak counter, encrypted badge, timeline view
Text: "Track your journey. Keep it private."

[25-30s] Logo + tagline
Text: "Morning Mindful - Journal First, Scroll Later"
```
